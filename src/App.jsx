...
export default function App() {
  ...
  // 1. Inventory State (Phase 4: Loads from LocalStorage, defaults to empty array)
  ...
  // Initialize the local WebGPU model using an inline blob worker to guarantee Vercel build success
  const initAI = async () => {
    ...
    try {
      ...
      // Bundles worker code as an inline Blob string to keep Vite compilation happy
      const workerCode = `
